...
class Fitnesschat extends StatelessWidget {
  const Fitnesschat({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // Add the Floating Action Button (FAB) for history
      /*floatingActionButton: FloatingActionButton(
        ...
        child:
            Icon(Icons.history, color: Colors.white), // Clock icon for history
      ),*/
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Hello! I\'m your Evo AI Health and Fitness, here to simplify help with fitness. Just ask me any question, and let\'s enjoy learning together.',
                            style: TextStyle(color: Colors.white),
                          ),
                        ],
                      ),
