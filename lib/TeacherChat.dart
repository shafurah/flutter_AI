...
class _TeacherchatState extends State<Teacherchat> {
  ...
  Future<String> fetchAIResponse(String userMessage) async {
    final endpoint =
        'https://ai-azureaistudioevocity129756908007.openai.azure.com/openai/deployments/evoteacher/chat/completions?api-version=2024-08-01-preview';
          ...
          'messages': [
            {
              'role': 'system',
              'content':
                  'You are an AI assistant that helps with document tasks like teaching students.'
            },
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5), // Space between title and icon
                  Icon(Icons.flash_on,
                      color: Colors.white, size: 20), // Lightning icon
                ],
              ),
              // Home and AI Feature buttons with History icon below AI Feature
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5), // Space between buttons and icon
                  TextButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  isUser ? Colors.deepPurple : Colors.grey[00],
